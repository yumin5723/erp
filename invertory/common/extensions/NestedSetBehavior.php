...
class NestedSetBehavior extends Behavior{
    ...
    public function beforeSave( $event ) {
        if ( $this->_ignoreEvent ) {
            ...
            throw new Exception( Yii::t( 'app', 'You should not use CActiveRecord::save() method when NestedSetBehavior attached.' ) );
        }
    }
    ...
    public function beforeDelete( $event ) {
        if ( $this->_ignoreEvent ) {
            ...
            throw new Exception( Yii::t( 'app', 'You should not use CActiveRecord::delete() method when NestedSetBehavior attached.' ) );
        }
    }
    ...
    private function makeRoot( $attributes ) {
        ...
        if ( $this->hasManyRoots ) {
            ...
            try{
                ...
                // print_r($owner->primaryKey());exit;
                $id = $owner->primaryKey();
                $rootAttribute = $this->rootAttribute;
                $owner->updateAll( [$id[0] => $pk], [$rootAttribute => $pk] );
